...
<body>
    ...
    <div class="section-title">Income Report Details</div>
    <table>
        <tr>
        ...
        <tr>
            <td>Received Date</td>
            <td>{{ $reportIncomingProduct->received_date }}</td>
        </tr>
        <tr>
            <td>Quantity</td>
            <td>{{ $reportIncomingProduct->quantity }}</td>
        </tr>
        <tr>
            <td>Quality Status</td>
            <td>{{ $reportIncomingProduct->quality_status }}</td>
        </tr>
        <tr>
            <td>Notes</td>
            <td>{{ $reportIncomingProduct->notes }}</td>
        </tr>
    </table>
</body>
</html>
